...
class BmiUpdate extends StatefulWidget {
  const BmiUpdate({Key? key}) : super(key: key);

  @override
  State<BmiUpdate> createState() => _BmiUpdateState();
}

class _BmiUpdateState extends State<BmiUpdate> {
  double hight = 150;
  int age = 18;
  double wight = 50.0;
  bool isMale = true;
