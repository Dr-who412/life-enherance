...
import 'package:life_partner/module/eating_disorder/disorder_screan.dart';
                ...
                BlocConsumer<SignCubit, SignState>(
                  listener: (context, state) {
                    ...
                    if (state is getWeeklyDietSuccess) {
                      ...
                      //   (route) => false,
                      // );
                      SignCubit.get(context).getQuestions();
                    }
                    if (state is getDisoredrSuccess) {
                      Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(builder: (_) => Disorder()),
                        (route) => false,
                      );
                    }
                  },
